...
UNIFI_SOFTWARE_URL="http://dl.ubnt.com/unifi/5.12.22/UniFi.unix.zip"
...
FREEBSD_PACKAGE_URL="http://pkg0.bme.freebsd.org/${ABI}/latest/All/"

# FreeBSD package list:
FREEBSD_PACKAGE_LIST_URL="http://pkg0.bme.freebsd.org/${ABI}/latest/packagesite.txz"
